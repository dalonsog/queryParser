...
module.exports = {
  ...
  AGGR: 'AGGREGATOR|OPEN_BRACKET|NAME|CLOSE_BRACKET',

  // From template
  FROM: 'FROM|NAME',

  // Where templates
  WHERE: 'WHERE|[#X;::#ALL_SEP;]',
  X: '{#MULTICONDITION;,#CONDITION;}',
  ...
  MULTICONDITION: 'OPEN_BRACKET|[#CONDITION;::#AND_OR_SEP;]|CLOSE_BRACKET',
